...
AWeapon::AWeapon()
{
	...
	WeaponMesh->SetCustomDepthStencilValue(CUSTOM_DEPTH_BLUE); // for post process highlight material
	WeaponMesh->MarkRenderStateDirty();
	EnableCustomDepth(true); // All weapons will start with custom depth enabled
